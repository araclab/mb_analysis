...
while (<FILE>) {
	...
	if (defined $phylaidx && $phylaidx ne '' && $phylaidx ne -1)
	{
		...
		else
		{
			...
			print $fh "$out[0]\t$new_taxa_arr[0];Unclassified;Unclassified;Unclassified;Unclassified;Unclassified\n";
	...
	if (defined $classidx && $classidx ne '' && $classidx ne -1)
	{
		...
		else
		{
			...
			print $fh "$out[0]\t$new_taxa_arr[0];$new_taxa_arr[3];Unclassified;Unclassified;Unclassified;Unclassified\n";
	...
	if (defined $orderidx && $orderidx ne '' && $orderidx ne -1)
	{
		...
		else
		{
			...
			print $fh "$out[0]\t$new_taxa_arr[0];$new_taxa_arr[3];$new_taxa_arr[6];Unclassified;Unclassified;Unclassified\n";
	...
	if (defined $familyidx && $familyidx ne '' && $familyidx ne -1)
	{
		...
		else
		{
			...
			print $fh "$out[0]\t$new_taxa_arr[0];$new_taxa_arr[3];$new_taxa_arr[6];$new_taxa_arr[9];Unclassified;Unclassified\n";
	...
	if (defined $genusidx && $genusidx ne '' && $genusidx ne -1)
	{
		...
		else
		{
			...
			print $fh "$out[0]\t$new_taxa_arr[0];$new_taxa_arr[3];$new_taxa_arr[6];$new_taxa_arr[9];$new_taxa_arr[12];$out[$genusidx-1]<0.8\n";
	...
	#print join("\n",@new_taxa_arr),"\n";
	#print("\n");
	print $fh "$out[0]\t$new_taxa_arr[0];$new_taxa_arr[3];$new_taxa_arr[6];$new_taxa_arr[9];$new_taxa_arr[12];$new_taxa_arr[15]\n";

...
export scripts='/GWSPH/groups/liu_price_lab/pegasus_bin/Tools/dada2_pipeline_scripts'
export qiime='/GWSPH/groups/liu_price_lab/pegasus_bin/Tools/qiime1/bin'
export rdp='/GWSPH/groups/liu_price_lab/pegasus_bin/Tools/RDP_classifiers/rdp_classifier_2.12/dist'
export v6species='/GWSPH/groups/liu_price_lab/pegasus_bin/Scripts/MiSeq16S-master/V6_species'
export database='/GWSPH/groups/liu_price_lab/pegasus_bin/Tools/dada2_pipeline_databases'
...
primer_path='/GWSPH/groups/liu_price_lab/pegasus_bin/Tools/dada2_pipeline_databases/amplicon_primers_bactquant.fasta'
...
#parallel --link --jobs $threads 'cutadapt --pair-filter any --no-indels -e 0.15 --discard-untrimmed -g file:$primer_path -G file:$primer_path -o primer_trimmed_reads/{1/}.gz -p primer_trimmed_reads/{2/}.gz {1} {2} > primer_trimmed_reads/{1/}_cutadapt_log.txt' ::: trimmed_reads/*_R1_*.fastq ::: trimmed_reads/*_R2_*.fastq
